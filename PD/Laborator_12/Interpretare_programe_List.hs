...
data Term = Var Name
            ...
            | App Term Term
            | Amb Term Term  --adaugam o instructiune nedeterminista; se concat rez obtinute
            | Fail           --pentru cazul in care programul esueaza
        deriving (Show)
...
showM = show --exista show predefinit pe liste
...
interp (App t1 t2) env = do
    ...
    apply f v
interp Fail _ = []
interp (Amb t1 t2) env = interp t1 env ++ interp t2 env --se concat listele rezultatelor
