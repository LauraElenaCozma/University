...
# Este utila pentru calcularea derivatei
# diff = expr.diff()
# print('f(x)=', expr)
# print("f'(x)=", diff)
...
dif_progresive = diferente_finite(x_discret, y_discret, metoda='progresive')

plt.figure(1)
plt.plot(domeniu, dy, c = 'k', linewidth=2, label='derivata exacta')
plt.plot(x_discret[1:-1], dif_progresive[1:-1], c='orange', linewidth=2, linestyle='--', label='diferente progresive')
plt.grid(True)
plt.axhline(0, c='black', linewidth=1)
plt.axvline(0, c='black', linewidth=1)
plt.xlabel('x')
...
plt.figure(2)
plt.plot(x_discret[1:-1], np.abs(df_ex_discret[1:-1] - dif_progresive[1:-1]), c='orange', label='Err progresive')
plt.grid(True)
plt.axhline(0, c='black', linewidth=1)
plt.axvline(0, c='black', linewidth=1)
plt.xlabel('x')
